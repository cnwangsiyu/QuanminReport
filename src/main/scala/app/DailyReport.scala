  ...
  def main(args: Array[String]): Unit = {
    ...
    sqlContext.sql(
      """
        ...
        |FROM quanmin_raw WHERE tag='monitor' AND room_id!=-1 AND v5>1 AND client_ip!="125.90.93.217" AND client_ip!="125.90.93.83" AND client_ip!="125.90.88.103" AND client_ip!="183.56.171.42" AND client_ip!="125.90.93.215" AND client_ip!="183.56.170.244" AND client_ip!="218.30.131.254"
